...
export const INITIAL_BATTERY: BatteryState = {
  ...
  dispatchMode: 'AUTO',
  status: 'IDLE',
  cellPackStatus: 'NORMAL',
  aiDecisionTitle: 'Autonomous Dispatch / Standby',
  aiDecisionReason: 'Solar generation (318 kW) and campus load (482 kW) balanced. BESS standing by in auto-mode with 78.5% reserve ready for peak shaving.',
  cellHealthPct: 98.4,
  cellTempC: 24.2,
